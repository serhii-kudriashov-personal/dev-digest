...
export class AgentsRepository {
  ...
  /**
   * Linked-skill count per agent for a whole workspace, as one grouped query —
   * the agents LIST renders a count on every card, and calling `linkedSkills`
   * per agent would make that an N+1.
   */
