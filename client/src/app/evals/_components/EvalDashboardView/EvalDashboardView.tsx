              ...
              <tbody>
                {data.agents.map((a) => (
                  <tr key={a.agent_id}>
                    ...
                    <td style={s.td}>{a.never_run ? dash : formatPct(a.last_run?.recall ?? null, dash)}</td>
                    <td style={s.td}>{a.never_run ? dash : formatPct(a.last_run?.precision ?? null, dash)}</td>
                    <td style={s.td}>
                    ...
                    <td style={s.td}>
                      {a.never_run
                        ? dash
                        : `${a.last_run?.cases_passed ?? 0}/${a.last_run?.cases_covered ?? 0}`}
                    </td>
                    <td style={s.td}>
                      {a.direction === null ? (
                        dash
